// Command load drives a running API and prints what it did. It is a
...
//	load --scenario enqueue --share-url "$URL" --rate 5 --duration 30s
package main
...
import (
	...
	"github.com/XploY04/reelpin-go/internal/load"
)
...
func run(args []string) error {
	...
	scenario := flags.String("scenario", "mixed", "health, reads, enqueue, poll or mixed")
	...
	plan, err := load.PlanFor(*scenario, *token, *shareURL)
	if err != nil {
		return err
	}
	if *workers < 1 {
