...
// ErrRetryable means every delivery failed for a reason that may pass. The
// caller retries through the queue rather than in a loop.
var ErrRetryable = errors.New("delivery failed transiently")
