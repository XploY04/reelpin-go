...
func exported(t *testing.T) map[string]map[string]bool {
	...
	m.ProviderCalls.WithLabelValues("gemini", "gemini-3.5-flash-lite", "extract", "measured").Inc()
	m.ProviderTokens.WithLabelValues("gemini", "gemini-3.5-flash-lite", "extract", "input").Inc()
